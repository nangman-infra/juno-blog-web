...
def REPO_SLUG = 'nangman-infra/juno-blog-web'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/juno-blog-web.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'juno-blog-web main push detected',
